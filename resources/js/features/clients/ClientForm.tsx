...
import { BadgePercent, Captions, ChartArea, Folder, FolderPen, FolderUp, Hash, MoveLeftIcon, PaintBucket, PencilLine, Rss, UploadIcon } from 'lucide-react'
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-start">
                    ...
                    <div className="flex flex-col gap-6 w-full">
                        ...
                        <Field>
                            ...
                            <FieldDescription>
                                Fill your name for the clients.
                            </FieldDescription>
                        </Field>
                        ...
                        <div className="flex justify-between items-center gap-10">
                            <Field>
                                ...
                                <FieldDescription>
                                    Fill your website for the client.
                                </FieldDescription>
                            </Field>
                        </div>
